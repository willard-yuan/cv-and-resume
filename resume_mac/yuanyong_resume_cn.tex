...
\cventry{2016.07 - 至今}{美团}{}{外卖风控部}{算法开发}{
\begin{itemize}
\item 开发新的商户抓取策略，维护、优化已有的商户抓取逻辑，做一些外卖业务上的数据分析、监控与报表.
\end{itemize}}
...
\item 负责桌面版本的开发，使用QT框架构建图形界面, 人眼检测算法核心部分演示：\link[视频]{http://yongyuan.name/project/}.
\end{itemize}}
...
\section{\textbf{开源项目}}
\cvline{2015.4 - 2016.4}{基于MatConvNet以及VGGNet卷积神经网络模型抽取特征，以余弦距离作为相似性度量写的一个CNN用于图像检索的实验工具包，详见\href{https://github.com/willard-yuan/CNN-for-Image-Retrieval}{GitHub.}}
