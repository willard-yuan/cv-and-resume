...
\homepage{个人主页：yongyuan.name}                       % optional, remove the line if not wanted
...
\social[github]{github: willard-yuan}
...
\section{\textbf{工作经历}}
\subsection{快手MMU计算机视觉算法工程师}
\cventry{}{短、长视频和图像检索、查重与拷贝检测，5年视觉检索经历，掌握了若干工业视觉检索系统线上主流算法}{}{}{}{}

\cventry{2017.01 - 至今}{第三代视频原创保护系统}{对百亿级短视频（千亿级视频帧）进行第三代算法升级，同时拓展至长视频原创保护}{}{}{
\begin{itemize}
\item 特征升级为simNet和dupNet。带领同事设计并研发了一种统一视觉近似重复和语义相似的特征学习框架，在此基础上分别获得了专门面向视频查重的dupNet特征和既可以面向视频查重又可以面向语义相似的simNet特征，3000万视频库离线实验评估，dupNet特征召回比第二代查重系统特征召回好XXX点，simNet比simNet特征比第二代查重系统特征召回好XXX点，dupNet上线应用于X站长视频原创保护.
\item 索引升级。带领同事设计并研发了一种结合图ANN和OPQ的索引算法hnswOPQ.
\end{itemize}}

\cventry{2016.12 - 2017.12}{第二代短视频原创保护系统}{对从0到1的短视频原创保护系统进行算法升级，以适应百亿级短视频原创保护}{}{}{
\begin{itemize}
\item 特征索引。设计并研发了一种基于OPQ特征量化编码的视频多帧索引及排序方法，全量索引平台xx亿视频量，与视频多帧倒排结构相比，检索召回提升4倍以上，全量上额外独立覆盖3\%+.
