...
\section{\textbf{工作经历}}
\cventry{2015/10--至今}{ETRACK眼控技术}{}{学生创业团队}{技术合伙人}{
\begin{itemize}
...
\cventry{2013/03--2016/06}{基于内容的图像检索(CBIR)}{}{课题研究方向}{}{
\begin{itemize}
...
\cventry{2015/01--2015/04}{基于卷积神经网络的CBIR演示原型系统PicSearch}{}{兴趣驱动型项目}{协作开发}{PicSearch是一个在线图像检索原型系统，使用到了CNN卷积网络模型.
\begin{itemize}
...
\cventry{2015/03--2015/07}{基于词袋模型的物体检索原型DupSearch}{}{兴趣驱动型项目}{独立开发}{DupSearch是一个针对object retrieval或duplicate search而写的图像检索原型系统.
\begin{itemize}
