...
\begin{itemize}
\item 精通CBIR技术及其检索性能指标评价，熟练掌握了BoW词袋模型、SIFT/SURF、VLAD等特征描述子。
...
\cventry{2015/01--2015/04}{基于卷积神经网络的CBIR演示原型系统PicSearch}{}{兴趣驱动型项目}{独立开发}{PicSearch是一个在线图像检索原型系统，使用到了CNN卷积网络模型，能取得非常满意的检索效果.
\begin{itemize}
...
\item 图像库测试规模达15万，可以获得了很不错的检索效果，算法原型系统已售予某公司，15万衣服库检索效果详见\href{https://github.com/willard-yuan/pkbigdata-image-search}{GitHub}，此外，对于广告logo的搜索也能取得很高的检索精度。
\end{itemize}}
...
\section{\textbf{IT技能}}
\cvline{编程语言}{\small 熟练Python, Matlab, 会C++/C, HTML, CSS}
\cvline{机器学习}{\small 精通CBIR技术，熟练掌握SVM、BoF、ANN、哈希等常见机器学习方法，了解深度学习模型}
\cvline{常用工具}{\small Linux、Mac OS、Git、Chrome、OpenCV, Python web开发框架Django}
...
\section{\textbf{语言}}
\cvline{英语}{\small CET-6和\small CET-4，具备阅读专业英文文献、写作及翻译能力，英文博客\href{http://www.csdn.net/article/2015-06-16/2824981}{译文}曾见诸CSDN云计算首页。}
