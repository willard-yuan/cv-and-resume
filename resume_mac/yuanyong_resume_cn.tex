...
\cventry{2013--至今}{基于内容的图像检索(CBIR)}{}{课题研究方向}{}{对大规模图像集，在保持低计算复杂度的前提下，尽可能的提高图像检索精度.
\begin{itemize}
...
\cventry{2015/03--至今}{基于词袋模型的物体检索原型DupSearch}{}{兴趣驱动型项目}{独立开发}{DupSearch是一个针对object retrieval或duplicate search而写的图像检索原型系统，具有较大的应用价值.
\begin{itemize}
...
\cventry{2014/04}{\textnormal{Xuelong Li}, \textbf{Yong Yuan} \textnormal{and Xiaoqiang Lu, Latent Semantic Minimal Hashing for Image Retrieval. IEEE TIP, 2016(MAJOR REVISION)} }{}{}{}{}
...
\cvlistdoubleitem{三好学生(2016年4月)}{Best Paper Runner-up Award(2014年7月)}
\cvlistdoubleitem{优秀学生巡回报告团成员(2012年12月)}{国家奖学金(2012年11月)}
\cvlistdoubleitem{校内一等奖学金(2011年11月)}{国家励志奖学金(2010年11月)}
%\vspace{-1em}      %缩小段落的间距
