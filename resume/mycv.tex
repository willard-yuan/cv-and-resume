...
\end{itemize}}
\cventry{2014--至今}{复杂低空飞行的自主避险理论与方法研究(973)}{}{项目参与者}{}{多源协同感知周围环境，对复杂低空环境中可能的危险障碍物进行实时检测，并完成飞行器的自主避险.
\begin{itemize}
...
\end{itemize}}
\cventry{2015.01--至今}{基于卷积神经网络的 CBIR 演示原型系统PicSearch}{}{自发项目}{}{PicSearch是一个在线图像检索演示系统，使用了流行的卷积神经网络提取图像特征，图库为包含29780张图片的Caltech256,能取得比较满意的检索效果.
\begin{itemize}
